...
func Apimanagementserviceskus_listavailableserviceskusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/skus%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, queryString)
		...
		var result models.ResourceSkuResults
...
func CreateApimanagementserviceskus_listavailableserviceskusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_skus",
		mcp.WithDescription("Gets available SKUs for API Management service"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Apimanagementserviceskus_listavailableserviceskusHandler(cfg),
	}
}

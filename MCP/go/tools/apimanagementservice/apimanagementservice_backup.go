...
func Apimanagementservice_backupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/backup%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, queryString)
...
func CreateApimanagementservice_backupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_backup",
		mcp.WithDescription("Creates a backup of the API Management service to the given Azure Storage Account. This is long running operation and could take several minutes to complete."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Apimanagementservice_backupHandler(cfg),
	}
}

...
func Apimanagementservice_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateApimanagementservice_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName",
		mcp.WithDescription("Gets an API Management service resource description."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Apimanagementservice_getHandler(cfg),
	}
}

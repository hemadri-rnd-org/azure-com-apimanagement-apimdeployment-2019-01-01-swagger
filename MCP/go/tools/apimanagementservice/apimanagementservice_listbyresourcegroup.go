...
func Apimanagementservice_listbyresourcegroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service%s", cfg.BaseURL, resourceGroupName, subscriptionId, queryString)
...
func CreateApimanagementservice_listbyresourcegroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service",
		mcp.WithDescription("List all API Management services within a resource group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Apimanagementservice_listbyresourcegroupHandler(cfg),
	}
}

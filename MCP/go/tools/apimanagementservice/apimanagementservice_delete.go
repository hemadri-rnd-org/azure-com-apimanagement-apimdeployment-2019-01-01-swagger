...
func Apimanagementservice_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateApimanagementservice_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName",
		mcp.WithDescription("Deletes an existing API Management service."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Apimanagementservice_deleteHandler(cfg),
	}
}
